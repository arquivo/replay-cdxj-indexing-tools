...
class TestRealisticScenarios(unittest.TestCase):
    ...
    def test_arquivo_comprehensive_filtering(self):
        ...
        cdxj_lines = [
            # Good content
            'pt,governo,www)/page 20230615120000 {"url": "...", "mime": "text/html", "status": "200"}\n',
            'pt,sapo,www)/news 20230615120000 {"url": "...", "mime": "text/html", "status": "200"}\n',
            
            # Spam domain
            'pt,spam,www)/page 20230615120000 {"url": "...", "mime": "text/html", "status": "200"}\n',
            
            # Good domain but blocked path (ads)
            'pt,publico,www)/ads/banner 20230615120000 {"url": "...", "mime": "image/jpeg", "status": "200"}\n',
            
            # Good domain but blocked MIME (Flash)
            'pt,rtp,www)/video 20230615120000 {"url": "...", "mime": "application/x-shockwave-flash", "status": "200"}\n',
            
            # Good domain but 404
            'pt,cm-lisboa,www)/missing 20230615120000 {"url": "...", "mime": "text/html", "status": "404"}\n',
            
            # More good content
            'pt,dn,www)/article 20230615120000 {"url": "...", "mime": "text/html", "status": "200"}\n',
        ]
