...
3. TestStreamChunksFromInput (5 tests) - Chunk Streaming Logic
   ...
   - test_stream_chunks_exact_size: Input lines divide evenly into chunks (e.g., 10 lines, chunk_size=5)
   - test_stream_chunks_with_remainder: Input with partial last chunk (e.g., 11 lines, chunk_size=5)
...
class TestCdxjToZipnum(unittest.TestCase):
    ...
    def test_single_shard_creation(self):
        ...
        lines = [f"org,example)/{i:05d} 20200101120000 {{\"status\": \"200\"}}\n".encode() 
                 for i in range(10)]
    ...
    def test_multiple_shards_creation(self):
        ...
        for i in range(3000):
            ...
            import random
            random_data = ''.join(random.choices('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789', k=200))
            line = f"org,example)/{i:06d} 20200101{i:06d} {{\"status\": \"200\", \"data\": \"{random_data}\"}}\n"
    ...
    def test_custom_idx_loc_names(self):
        ...
        cdxj_to_zipnum(self.output_dir, input_file, 
                      idx_name="my-index.idx", loc_name="my-locations.loc")
    ...
    def test_real_cdxj_data(self):
        ...
        real_cdxj_lines = [
            b'pt,aas,www)/ 20230615120000 {"url": "http://www.aas.pt/", "mime": "text/html", "status": "200", "digest": "ABCD1234", "length": "5000", "offset": "1000", "filename": "test.warc.gz"}\n',
            b'pt,edp,www)/ 20230615120100 {"url": "http://www.edp.pt/", "mime": "text/html", "status": "200", "digest": "EFGH5678", "length": "6000", "offset": "2000", "filename": "test.warc.gz"}\n',
            b'pt,governo,www)/ 20230615120200 {"url": "http://www.governo.pt/", "mime": "text/html", "status": "200", "digest": "IJKL9012", "length": "7000", "offset": "3000", "filename": "test.warc.gz"}\n',
            b'pt,sapo,www)/ 20230615120300 {"url": "http://www.sapo.pt/", "mime": "text/html", "status": "200", "digest": "MNOP3456", "length": "8000", "offset": "4000", "filename": "test.warc.gz"}\n',
            b'pt,uc,www)/ 20230615120400 {"url": "http://www.uc.pt/", "mime": "text/html", "status": "200", "digest": "QRST7890", "length": "9000", "offset": "5000", "filename": "test.warc.gz"}\n',
        ]
